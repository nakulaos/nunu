...
var (
	...
	ErrUnauthorizedTokenError    = xerror.NewError(10007, "ErrUnauthorizedTokenError")
	ErrUnauthorizedTokenTimeout  = xerror.NewError(10008, "ErrUnauthorizedTokenTimeout")
	...
	ErrNoAdminPermission            = xerror.NewError(20015, "ErrNoAdminPermission")
